...
export function LeadHeader({ lead, onStageChange }: LeadHeaderProps) {
  ...
  return (
    ...
    <div className="px-6 py-4 bg-white border-b border-af-border space-y-4">
      ...
      {/* Linha 3: dados operacionais — responsável / funil / estágio */}
      <div className="grid grid-cols-3 gap-3 bg-slate-50 border border-af-border rounded-xl p-3">
        <div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="w-full text-sm font-medium px-2 py-1.5 border border-af-border rounded-lg bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-af-accent cursor-pointer disabled:opacity-50 min-w-0"
            >
              {users.map(u => (
        ...
        <div>
          ...
          <div className="flex items-center gap-1.5">
            <span className="flex-1 text-sm font-medium text-slate-700 bg-white border border-af-border px-2.5 py-1.5 rounded-lg truncate">
              {lead.pipeline.name}
            </span>
            <button
        ...
        <div>
          ...
          <select
            ...
            disabled={changing}
            className="w-full text-sm font-medium px-2.5 py-1.5 border border-af-border rounded-lg bg-white text-af-mid focus:outline-none focus:ring-2 focus:ring-af-accent cursor-pointer min-w-0"
          >
      ...
      {/* Linha 4: ações de status — compactas, em linha */}
      <div className="flex items-center flex-wrap gap-1.5">
