...
const ACTION_TYPES = ['send_message', 'send_template', 'assign_agent', 'move_stage', 'move_stage_by_name', 'add_note', 'add_tag', 'start_salesbot', 'webhook', 'activate_ai', 'deactivate_ai'] as const;
